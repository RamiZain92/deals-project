...
public final class AppConstants {
	...
	public static final String PROFILE_IMAGE_UPDATED_SUCCESSFULLY="PROFILE_IMAGE_UPDATED_SUCCESSFULLY";
	public static final String INVALID_USER_ID="INVALID_USER_ID";
	public static final String LICENCE_NUMBER_IMAGE_UPDATED_SUCCESSFULLY="LICENCE_NUMBER_IMAGE_UPDATED_SUCCESSFULLY";
	public static final String USER_ID_IMGAE_UPDATED_SUCCESSFULLY="USER_ID_IMGAE_UPDATED_SUCCESSFULLY";
	public static final String VEHICLE_IMAGES_LIMIT_EXCEEDED="VEHICLE_IMAGES_LIMIT_EXCEEDED";
	public static final String VEHICLE_iMAGES_UPLOADED_SUCCESSFULLY="VEHICLE_iMAGES_UPLOADED_SUCCESSFULLY";
	public static final String VEHICLE_NOT_REGISTERED_AGAINST_LOGGED_USER="VEHICLE_NOT_REGISTERED_AGAINST_LOGGED_USER";
	public static final String IMAGE_ID_REQUIRED="IMAGE_ID_REQUIRED";
	public static final String CANNOT_REMOVE_ALL_VEHICLE_IMAGES="CANNOT_REMOVE_ALL_VEHICLE_IMAGES";
	public static final String IMAGE_NOT_FOUND="IMAGE_NOT_FOUND";
	public static final String VEHICLE_IMAGE_DELETED_SUCESSFULLY="VEHICLE_IMAGE_DELETED_SUCESSFULLY";
	public static final String ADDRESS_UPDATED_SUCCESSFULLY="ADDRESS_UPDATED_SUCCESSFULLY";
}